...
export default function C2() {
    const { isim, setIsim } = useContext<GlobalContextType>(GlobalHavuz);

    function isimDegistir(event: React.MouseEvent<HTMLButtonElement, MouseEvent>): void {
        if (isim !== "Kağan") setIsim("Kağan");
        else setIsim("Oğuzhan");
    }
